...
def main() -> None:
    ...
    parser.add_argument("--xml", default="assets/unitree_g1/g1_29dof_rev_1_0.xml", help="单机器人 MuJoCo XML 路径")
    parser.add_argument("--output", default="motion_fsq_reconstruction/mujoco_eval", help="评估输出目录")
    parser.add_argument("--motion", default="dataset_converter/test_out_export/nymeria_batch/20230607_s0_james_johnson_act0_e72nhq/soma_bvh/nymeria_soma.npz", help="单个 motion npz 路径")
